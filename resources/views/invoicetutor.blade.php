        ...
        <div class="row" style="align-items: center;justify-content:center;display:flex;margin-bottom:30px">
            ...
            <div class="col-md-12 col-lg-12 ">
                    ...
                    <div class=" col-lg-12 col-xl-12">
                        ...
                        <button type="button" class="button-form btn-add-now mb-2 px-4">
                            <span class="button_textform"><a class ="link" href="{{url('/invoicetutorAfter')}}"style="text-decoration: none">Cairkan Uang</a></span>
                        </button>
                    </div>
