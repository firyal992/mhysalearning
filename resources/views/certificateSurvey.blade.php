...
<link href="{{ asset('css/sertifikatSurvey.css') }}" rel="stylesheet">
...
<div class="container p-0">
    ...
    <h4 class="entry-title" style="margin-left: 25px;font-family:'Lato';font-size:18px;font-weight:400px;"><a href="/certificateSurvey2" class="link2">Isi Survey dan dapatkan Sertifikat kamu</a></h4>
</div>
@endsection